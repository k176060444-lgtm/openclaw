...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Son terminal operatörü onayları.",
  ...
  approvalHistory: {
    description:
      "Bu Gateway tarafından kaydedilen terminal yürütme, eklenti ve sistem aracısı onayları; en yeniler önce gösterilir.",
    loading: "Onay geçmişi yükleniyor…",
    loadingMore: "Yükleniyor…",
    loadMore: "Daha fazla yükle",
    empty: "Son 30 günlük dönem içinde terminal onayı yok.",
