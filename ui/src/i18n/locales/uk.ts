...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Останні схвалення оператора термінала.",
  ...
  approvalHistory: {
    description:
      "Схвалення виконання команд у терміналі, плагінів і системного агента, зареєстровані цим Gateway, від найновіших до найстаріших.",
    loading: "Завантаження історії схвалень…",
    loadingMore: "Завантаження…",
    loadMore: "Завантажити ще",
    empty: "Немає схвалень термінала за останні 30 днів.",
    retention: "Історія схвалень охоплює останні 30 днів.",
    offline: "Підключіться до Gateway, щоб завантажити історію схвалень.",
    invalidResponse: "Gateway повернув некоректну відповідь щодо історії схвалень.",
    unknown: "Невідомо",
    notApplicable: "Н/Д",
    columns: {
      resolved: "Вирішено",
