...
export const id: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Persetujuan operator terminal terbaru.",
  ...
  approvalHistory: {
    description:
      "Persetujuan eksekusi terminal, plugin, dan agen sistem yang dicatat oleh gateway ini, mulai dari yang terbaru.",
    loading: "Memuat riwayat persetujuan…",
    loadingMore: "Memuat…",
    loadMore: "Muat lebih banyak",
    empty: "Tidak ada persetujuan terminal dalam periode bergulir 30 hari.",
    retention: "Riwayat persetujuan mencakup periode bergulir 30 hari.",
