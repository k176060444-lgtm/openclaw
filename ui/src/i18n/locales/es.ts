...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Aprobaciones recientes de operadores de terminal.",
  ...
  approvalHistory: {
    description:
      "Aprobaciones de ejecución en terminal, plugins y agentes del sistema registradas por este gateway, de la más reciente a la más antigua.",
    loading: "Cargando historial de aprobaciones…",
    loadingMore: "Cargando…",
    loadMore: "Cargar más",
    empty: "No hay aprobaciones de terminal en el periodo móvil de 30 días.",
    retention: "El historial de aprobaciones abarca un periodo móvil de 30 días.",
    ...
    reasons: {
      ...
      gatewayRestart: "Reinicio del Gateway",
