...
export const ru: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Недавние подтверждения оператором терминала.",
  ...
  approvalHistory: {
    description:
      "Подтверждения выполнения команд в терминале, плагинов и системного агента, зарегистрированные этим Gateway, начиная с самых новых.",
    loading: "Загрузка истории подтверждений…",
    loadingMore: "Загрузка…",
    loadMore: "Загрузить ещё",
    empty: "За последние 30 дней подтверждений в терминале не было.",
    retention: "История подтверждений хранится за последние 30 дней.",
    offline: "Подключитесь к Gateway, чтобы загрузить историю подтверждений.",
    invalidResponse: "Gateway вернул некорректный ответ с историей подтверждений.",
    unknown: "Неизвестно",
    notApplicable: "Н/Д",
    columns: {
      resolved: "Разрешено",
