...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Kürzlich erteilte Terminal-Bedienerfreigaben.",
  ...
  attention: {
    ...
    pendingApproval: "{count} ausstehende Freigabe",
    pendingApprovals: "{count} ausstehende Freigaben",
  },
  approvalHistory: {
    description:
      "Von diesem Gateway erfasste Freigaben für Terminal-Ausführungen, Plugins und Systemagenten, neueste zuerst.",
    loading: "Freigabeverlauf wird geladen…",
    loadingMore: "Wird geladen…",
    loadMore: "Mehr laden",
    empty: "Keine Terminal-Freigaben im gleitenden 30-Tage-Zeitraum.",
    retention: "Der Freigabeverlauf umfasst einen gleitenden 30-Tage-Zeitraum.",
    offline: "Stellen Sie eine Verbindung zum Gateway her, um den Freigabeverlauf zu laden.",
    invalidResponse: "Das Gateway hat eine ungültige Antwort zum Freigabeverlauf zurückgegeben.",
    unknown: "Unbekannt",
    notApplicable: "k. A.",
    columns: {
    ...
    reasons: {
      ...
      malformedVerdict: "Ungültig formatiertes Urteil",
      noRoute: "Keine Route",
