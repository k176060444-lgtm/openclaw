...
export const ja_JP: TranslationMap = {
  ...
  attention: {
    ...
    pendingApproval: "{count} 件の承認待ち",
    pendingApprovals: "{count} 件の承認待ち",
  },
  approvalHistory: {
    description:
      "この Gateway によって記録されたターミナル実行、プラグイン、システムエージェントの承認を、新しい順に表示します。",
    loading: "承認履歴を読み込んでいます…",
    loadingMore: "読み込み中…",
    loadMore: "さらに読み込む",
    empty: "過去30日間のターミナル承認はありません。",
    retention: "承認履歴には過去30日間の記録が保持されます。",
    offline: "承認履歴を読み込むには Gateway に接続してください。",
    invalidResponse: "Gateway から無効な承認履歴レスポンスが返されました。",
    unknown: "不明",
    notApplicable: "該当なし",
    columns: {
      resolved: "解決日時",
    ...
    reasons: {
      user: "ユーザーによる決定",
      timeout: "タイムアウト",
      malformedVerdict: "不正な形式の判定",
      noRoute: "ルートなし",
      runAborted: "実行が中止されました",
      gatewayRestart: "Gatewayの再起動",
