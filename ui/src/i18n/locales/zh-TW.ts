...
export const zh_TW: TranslationMap = {
  ...
  approvalHistory: {
    description: "此 Gateway 記錄的終端機執行、外掛程式及系統代理程式核准記錄，由新至舊排列。",
    loading: "正在載入核准記錄…",
    loadingMore: "正在載入…",
    loadMore: "載入更多",
    empty: "最近 30 天的滾動期間內沒有終端機核准記錄。",
    retention: "核准記錄會保留最近 30 天的滾動期間。",
    offline: "請連線至 Gateway 以載入核准記錄。",
    invalidResponse: "Gateway 傳回的核准記錄回應無效。",
    unknown: "未知",
    notApplicable: "不適用",
    columns: {
      resolved: "已處理",
