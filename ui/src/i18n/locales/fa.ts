...
export const fa: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "تأییدهای اخیر اپراتور ترمینال.",
  ...
  approvalHistory: {
    description:
      "تأییدهای اجرای ترمینال، افزونه و عامل سیستم که توسط این Gateway ثبت شده‌اند، از جدیدترین به قدیمی‌ترین.",
    loading: "در حال بارگیری تاریخچه تأییدها…",
    loadingMore: "در حال بارگیری…",
    loadMore: "بارگیری بیشتر",
    empty: "در بازه چرخشی ۳۰ روزه، هیچ تأیید ترمینالی وجود ندارد.",
    retention: "تاریخچه تأییدها در یک بازه چرخشی ۳۰ روزه نگهداری می‌شود.",
    ...
    decisions: {
      allowOnce: "فقط این بار مجاز است",
      allowAlways: "همیشه مجاز است",
      deny: "رد",
    },
    reasons: {
      user: "تصمیم کاربر",
      ...
      noRoute: "مسیری وجود ندارد",
      runAborted: "اجرا لغو شد",
