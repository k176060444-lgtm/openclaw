...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "Các phê duyệt gần đây của người vận hành terminal.",
  ...
  attention: {
    ...
    pendingApproval: "{count} phê duyệt đang chờ",
    pendingApprovals: "{count} phê duyệt đang chờ",
  },
  approvalHistory: {
    description:
      "Các phê duyệt thực thi terminal, plugin và tác nhân hệ thống do Gateway này ghi lại, mới nhất trước.",
    loading: "Đang tải lịch sử phê duyệt…",
    loadingMore: "Đang tải…",
    loadMore: "Tải thêm",
    empty: "Không có phê duyệt terminal nào trong khoảng thời gian 30 ngày gần nhất.",
    retention: "Lịch sử phê duyệt được lưu trong khoảng thời gian 30 ngày gần nhất.",
    ...
    reasons: {
      ...
      malformedVerdict: "Kết luận không đúng định dạng",
