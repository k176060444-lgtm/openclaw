...
export const ar: TranslationMap = {
  ...
  subtitles: {
    ...
    approvals: "الموافقات الأخيرة لمشغّل الطرفية.",
  ...
  approvalHistory: {
    description:
      "موافقات تنفيذ أوامر الطرفية والمكوّنات الإضافية ووكلاء النظام التي سجّلها هذا Gateway، من الأحدث إلى الأقدم.",
    loading: "جارٍ تحميل سجل الموافقات…",
    loadingMore: "جارٍ التحميل…",
    loadMore: "تحميل المزيد",
    empty: "لا توجد موافقات للطرفية خلال نافذة الاحتفاظ المتجددة البالغة 30 يومًا.",
    retention: "يحتفظ سجل الموافقات ببيانات آخر 30 يومًا بشكل متجدد.",
    offline: "اتصل بـ Gateway لتحميل سجل الموافقات.",
    invalidResponse: "أعاد Gateway استجابة غير صالحة لسجل الموافقات.",
    unknown: "غير معروف",
    ...
    reasons: {
      ...
      malformedVerdict: "حكم بتنسيق غير صالح",
      noRoute: "لا يوجد مسار",
      runAborted: "تم إلغاء التشغيل",
